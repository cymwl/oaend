...
SECRET_KEY = 'django-insecure-l-^mklosrgu&)h6sf=h+uk!c!7v(wv9z*s3m(zaqz!b=5c3b^_'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': ['apps.oaauth.authentication.UserTokenAuthentication']
}
